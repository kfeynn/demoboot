...
<head>
    ...
    <span class="icon-bar"></span>
        ...
        <a href="${pageContext.request.contextPath}/malladmin/" class="navbar-brand">
    <small>
    ...
    <div class="navbar-buttons navbar-header pull-right" role="navigation">
        ...
        <c:if test ="${userCName == null || userCName == ''}">
            <li>
                <a href="${pageContext.request.contextPath}/malladmin/" id="loginLink" target="_parent">[登录]</a>
            </li>
        </c:if>
        <c:if test ="${userCName != null && userCName != ''}">
            <li>
                <a href="${pageContext.request.contextPath}/malladmin/" target="_parent">
