...
function deletePqAtion(sid)
{
    ...
    $.ajax({
        dataType: "json",
        type: 'post',
        url: '/malladmin/checkdata/DeletePq',
        data: {
            sid: sid //文本输入框的内容
        },
...
function QueryPqData(RecDataId)
{
    $.ajax({
        type: 'post',
        url: '/malladmin/checkdata/GetPqList',
        dataType: "json",
        data: {
...
function validateForAdd()
{
    ...
    $.ajax({
        dataType: "json",
        type: 'post',
        url: '/malladmin/checkdata/IsExistsAjax',
        data: {
            PrdtId: prdtId ,  
            CheckDate: $("#CheckDate").val(),
            PrdtLotNo: $("#PrdtLotNo").val(),
            PrdtInfo: $("#PrdtInfo").val(),
            PushOrderId: $("#PushOrderId").val(),
        },
        async: false, //取消异步
        success: function (data, status) {
            //alert(data.content);
...
function addPqInfo(sid) {
    if (sid == 0) {
        ...
        $.ajax({
            type: 'post',
            url: '/malladmin/checkdata/AddPqModel',
            dataType: "json",
            data: {
                sid: sid,
...
function checkPqAtion(sid)
{
    if (sid == 0) {
        ...
        $.ajax({
            type: 'post',
            url: '/malladmin/checkdata/CheckPqNumberAjax',
            dataType: "json",
            data: {
                sid: sid
            },
